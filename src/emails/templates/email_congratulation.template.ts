export function emailSuccessTemplate(nameEnterprise: string) {
...
<div id="email">
  ...
  <table role="presentation" bgcolor="#EAF0F6" width="100%" style="margin-top: 50px;" >
    <tr>
        ...
        <h3> Congratulations on Registering Successfully!</h3>
        <h4>Dear ${nameEnterprise} </h4>
        <p>
          We are delighted to inform you that your registration for an account with us was successful! We would like to take this opportunity to congratulate you and welcome you to our community. We are thrilled to have you onboard and look forward to providing you with our best services.  
        </p>
        <p>
          Your registration is an important step towards accessing our platform's full range of features and benefits. We are confident that you will find our platform user-friendly and easy to navigate.
        </p>
        <p>
        If you encounter any difficulties or have any questions, please don't hesitate to contact our support team, who will be more than happy to assist you.
        Once again, congratulations on your successful registration. We look forward to a long and fruitful relationship with you.
        </p>
